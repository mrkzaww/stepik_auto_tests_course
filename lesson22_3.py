...
try:
    ...
    browser.find_element(By.NAME, "firstname").send_keys("Milana")
    browser.find_element(By.NAME, "lastname").send_keys("Araslanova")
    browser.find_element(By.NAME, "email").send_keys("milana.araslanova@yandex.ru")
